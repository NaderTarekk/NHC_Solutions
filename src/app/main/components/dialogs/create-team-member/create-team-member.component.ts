...
export class CreateTeamMemberComponent {
  ...
  constructor(public dialogRef: MatDialogRef<CreateTeamMemberComponent>, private fb: FormBuilder, private service: MainService, private toastr: ToastrService) { }
  ...
  onSubmit(): void {
    ...
    this.service.AddNewTeamMember(formData, token).subscribe(res => {
